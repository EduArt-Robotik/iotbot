...
| D      | Auxiliary power supply. Pins are labeled from left to right: <br> VAUX1 (3 pin): 12 V, 5 V, GND <br> VAUX2 (4 pin): 19 V, 12 V, NC, GND <br> **Note:** Only either of the voltages on each socket is available, dependent on the DIP-Switch (see C) |
